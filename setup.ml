...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1505a68288fdc7a5f2a0b12f3138fd52) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          name = "OCaml Iter";
          version = "0.1.0-0";
          license = OASISLicense.OtherLicense "http://movvo.com";
          license_file = None;
          copyrights = [];
          maintainers = [];
          authors = ["Rizo Isrof <rizo@odis.io>"];
          homepage = Some "http://github.com/rizo/ocaml-iter";
          synopsis =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "camlp4o"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\005q\nl/\152\133\135≠¿Î\005)U\143d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
